                    ...
                    <div className="md:hidden flex items-center">
                        <Menu>
                            ...
                            <MenuList minW='min-content'>
                                <MenuItem icon={<EditIcon />} _hover={{ background: "#6A91A7", color: '#fff' }} as={Link} href="/login">
                                    Login
                                </MenuItem>
                                <MenuItem icon={<AddIcon />} _hover={{ background: "#6A91A7", color: '#fff' }} as={Link} href="/register">
                                    Register
                                </MenuItem>
                            </MenuList>
                        </Menu>
